...
public class Bullet : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (damageable != null)
        {
            ...
            /*PlayerPoints points = GameObject.FindWithTag("Player").GetComponent<PlayerPoints>(); //Utilizar um jeito m�todo dps, referenciar o player pra cada bala ficar� pesado, talvez enum?
            if (points != null)
            {
